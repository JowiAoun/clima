...
PrefGroup {
    ...
    // weather conditions (restart required)", which is wrong about Climat twice:
    ...
    // one: it means follow the desktop, which Climat does live over
    ...
    PrefRow {
        ...
        subtitle: qsTr("A desktop notification when a warning arrives and Climat is not "
