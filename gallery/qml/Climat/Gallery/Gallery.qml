...
//
//   climat-gallery                        open it
//   climat-gallery uv                     open it on a particular component
//   climat-gallery --grab g.png --size 1500x950
//
// `import Climat` is what makes the components on the stage the app's components
...
// directory up, because Climat.Gallery maps one level below Climat. The ramps
