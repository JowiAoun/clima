...
// this file moved out of the Climat module that was also a working relative URL,
// because the specimen and its subject sat in the same directory. They do not
// any more: this is Climat.Gallery and DetailUvCard.qml is in Climat, and
// `Qt.createComponent("DetailUvCard.qml")` from here resolves against
// `qrc:/qt/qml/Climat/Gallery/` and finds nothing. Every one of the sixty
...
// module URI and a *type* name and resolves it the way `import Climat` does -
...
// back as a component in the Error state carrying `Module "Climat" contains no
...
Item {
    ...
    function buildNow() {
        ...
        var c = Qt.createComponent("Climat", typeName)
        if (c === null) {
            error = "Climat." + typeName + " is not a component name"
            return
        }
