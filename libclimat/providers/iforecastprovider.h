...
// express the thing the UI actually needs to know, and app/qml/Climat/metrics.js
// already wrote down what that is, in its own header, before any of this
// existed:
//
//     "In libclimat this becomes a C++ registry populated from provider
...
// The chain in libclimat/providers/registry.h branches on ErrorKind to decide
...
// the tab bar in app/qml/Climat/metrics.js is built from these, and so is every
