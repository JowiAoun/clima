...
//
// Open-Meteo's JSON, field by field, into libclimat/domain/forecast.h.
//
...
// downstream, in app/qml/Climat/metrics.js's `format()`.
//
...
//
// `libclimat/domain/hourconvention.h`'s `asHourStarting()` is that boundary, it
...
//
// It is a WMO code, and app/qml/Climat/precip.js's `cellFor(mm, tempC, code)`
...
// libclimat/domain/weathercode.h and it is deliberately not in this file:
...
// libclimat/providers/iforecastprovider.h makes an incomplete one a registration
// failure.
