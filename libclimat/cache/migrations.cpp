...
Status createVersion1(QSqlDatabase &database)
{
    ...
    // applet and a CLI reusing libclimat have no QSettings of the app's and
...
// actually has is a home marker: app/qml/Climat/LocationBar.qml draws one ring
...
Status runMigrations(QSqlDatabase &database, const QList<Migration> &migrations, Clock *clock)
{
    ...
    // newer Climat is refused: we do not know what its extra columns mean, and
