...
//
// The only thing in Climat that talks to the internet.
//
...
// promises Climat makes to the services it uses for free are enforced here and
...
//
// See libclimat/net/backoff.h for the schedule and for why the jitter is
