...
// libclimat/CMakeLists.txt and DeviceLocator::create(), which is the only thing
// that constructs this.
//
// ---- Qt6::Positioning links Qt6::Core and nothing else ----------------------
//
// Checked, and it has to be: cmake/ClimatEngineGuard.cmake refuses to configure
// a libclimat whose link closure reaches Qt6::Gui, and a positioning module that
